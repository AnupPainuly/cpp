...
#include<iostream>
using namespace std;
int sum(int a=0,int b=0,int c=0,int d=0)// default argument is given right to left in consecutive order
{
  return a+b+c+d;
...
/*Note: The default arguments are passed in function definition when function is written as below.
